        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <img src="images/logo-mini.png" width="40" alt="">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="img-flex-gen">
                                    <div class="steam-gen-card">
                                        <img class="img-respo card-value" src="images/10-gift.jpg" alt="" data-value="10€">
                                    </div>

                                    <div class="steam-gen-card">
                                        <img class="img-respo card-value" src="images/20-gift.jpg" alt="" data-value="20€">
                                    </div>

                                    <div class="steam-gen-card">
                                        <img class="img-respo card-value" src="images/50-gift.jpg" alt="" data-value="50€">
                                    </div>

                                    <div class="steam-gen-card">
                                        <img class="img-respo card-value" src="images/100-gift.jpg" alt="" data-value="100€">
                                    </div>
                                </div>
                                ...
                                <br>
                                <a class="btn btn-default btn-lg btn-block btn-steam-gray pulse-shadow generate" >Click Here <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- change this onclick function with function from  your network. -->
                        <button id="proceed" class="btn btn-default btn-lg btn-block btn-steam-gray" onclick="alert('demo')">PROCEED TO VERIFY</button>
                    </div>
                </div>
