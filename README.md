...
#### Preview
---
![Landing Page Preview](https://github.com/cpa-landing-pages/steam-gift/blob/master/preview.png)

#### Download
---
[<img src="http://svgshare.com/i/28_.svg" width="40%" alt="Download" />](https://github.com/cpa-landing-pages/steam-gift/archive/master.zip)
...
> Step 6 (optional)
- To change JS, open `scripts/script.min.js` and beautify the file. You can Google for "JS Beautify" or you can use the one that we mentioned for any file type. Make sure to minify the file after you're done, for faster page load.
